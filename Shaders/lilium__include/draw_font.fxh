...
static const uint2 CharSize[24] = {
  FONT_SIZE_58_CHAR_DIM,
  FONT_SIZE_56_CHAR_DIM,
  FONT_SIZE_54_CHAR_DIM,
  FONT_SIZE_52_CHAR_DIM,
  FONT_SIZE_50_CHAR_DIM,
  FONT_SIZE_48_CHAR_DIM,
  FONT_SIZE_46_CHAR_DIM,
  FONT_SIZE_44_CHAR_DIM,
  FONT_SIZE_42_CHAR_DIM,
  FONT_SIZE_40_CHAR_DIM,
  FONT_SIZE_38_CHAR_DIM,
  FONT_SIZE_36_CHAR_DIM,
  FONT_SIZE_34_CHAR_DIM,
  FONT_SIZE_32_CHAR_DIM,
  FONT_SIZE_30_CHAR_DIM,
  FONT_SIZE_28_CHAR_DIM,
  FONT_SIZE_26_CHAR_DIM,
  FONT_SIZE_24_CHAR_DIM,
  FONT_SIZE_22_CHAR_DIM,
  FONT_SIZE_20_CHAR_DIM,
  FONT_SIZE_18_CHAR_DIM,
  FONT_SIZE_16_CHAR_DIM,
  FONT_SIZE_14_CHAR_DIM,
  FONT_SIZE_13_CHAR_DIM };

uint2 GetCharSize(const uint AtlasArrayEntry)
{
  return CharSize[AtlasArrayEntry];
}
...
uint GetAtlasXOffset(const uint AtlasArrayEntry)
{
  return AtlasXOffset[AtlasArrayEntry];
}
...
static const uint2 WaveCharSize[11] = {
  WAVE_FONT_SIZE_32_CHAR_DIM,
  WAVE_FONT_SIZE_30_CHAR_DIM,
  WAVE_FONT_SIZE_28_CHAR_DIM,
  WAVE_FONT_SIZE_26_CHAR_DIM,
  WAVE_FONT_SIZE_24_CHAR_DIM,
  WAVE_FONT_SIZE_22_CHAR_DIM,
  WAVE_FONT_SIZE_20_CHAR_DIM,
  WAVE_FONT_SIZE_18_CHAR_DIM,
  WAVE_FONT_SIZE_16_CHAR_DIM,
  WAVE_FONT_SIZE_14_CHAR_DIM,
  WAVE_FONT_SIZE_13_CHAR_DIM };

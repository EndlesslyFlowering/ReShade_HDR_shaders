...
#define WAVEFORM_SCALE_WAS_DRAWN_TO_COUNT 1
#define WAVEFORM_SCALE_WAS_DRAWN_TO_X_OFFSET (UNROLLING_BE_GONE_VARIABLES_COUNT + UNROLLING_BE_GONE_VARIABLES_X_OFFSET)
#define WAVEFORM_SCALE_WAS_DRAWN_TO_Y_OFFSET 0
#define COORDS_WAVEFORM_SCALE_WAS_DRAWN_TO int(WAVEFORM_SCALE_WAS_DRAWN_TO_X_OFFSET)


#ifdef IS_COMPUTE_CAPABLE_API

// waveform variables
#define WAVEFORM_VARIABLES_COUNT 6
#define WAVEFORM_VARIABLES_X_OFFSET (WAVEFORM_SCALE_WAS_DRAWN_TO_COUNT + WAVEFORM_SCALE_WAS_DRAWN_TO_X_OFFSET)
#define WAVEFORM_VARIABLES_Y_OFFSET 0
#define COORDS_WAVEFORM_LAST_SIZE_X           int(    WAVEFORM_VARIABLES_X_OFFSET)
#define COORDS_WAVEFORM_LAST_SIZE_Y           int(1 + WAVEFORM_VARIABLES_X_OFFSET)
#define COORDS_WAVEFORM_LAST_CUTOFF_POINT     int(2 + WAVEFORM_VARIABLES_X_OFFSET)
#define COORDS_WAVEFORM_LAST_MODE             int(3 + WAVEFORM_VARIABLES_X_OFFSET)
#define COORDS_WAVEFORM_LAST_TEXT_SIZE_ADJUST int(4 + WAVEFORM_VARIABLES_X_OFFSET)
#define COORDS_WAVEFORM_TIMER                 int(5 + WAVEFORM_VARIABLES_X_OFFSET)


// CIE diagram variables
#define CIE_DIAGRAM_VARIABLES_COUNT 4
#define CIE_DIAGRAM_VARIABLES_X_OFFSET (WAVEFORM_VARIABLES_COUNT + WAVEFORM_VARIABLES_X_OFFSET)
#define CIE_DIAGRAM_VARIABLES_Y_OFFSET 0
#define CIE_DIAGRAM_TYPE_ENCODE_OFFSET                         20
#define CIE_DIAGRAM_GAMUT_OUTLINE_POINTERS_SHOW_ENCODE_OFFSET  21
#define CIE_DIAGRAM_GAMUT_OUTLINE_BT709_SHOW_ENCODE_OFFSET     22
#define CIE_DIAGRAM_GAMUT_OUTLINE_DCIP3_SHOW_ENCODE_OFFSET     23
#define CIE_DIAGRAM_GAMUT_OUTLINE_BT2020_SHOW_ENCODE_OFFSET    24
#define CIE_DIAGRAM_TYPE_BIT                         0x00100000
#define CIE_DIAGRAM_GAMUT_OUTLINE_POINTERS_SHOW_BIT  0x00200000
#define CIE_DIAGRAM_GAMUT_OUTLINE_BT709_SHOW_BIT     0x00400000
#define CIE_DIAGRAM_GAMUT_OUTLINE_DCIP3_SHOW_BIT     0x00800000
#define CIE_DIAGRAM_GAMUT_OUTLINE_BT2020_SHOW_BIT    0x01000000
...
#define COORDS_CIE_RENDER_PROGRESS int(3 + CIE_DIAGRAM_VARIABLES_X_OFFSET)
...
)
{
  ...
  return Csp::Map::BT709_Into::scRGB(Colour, Brightness);

#elif (ACTUAL_COLOUR_SPACE == CSP_HDR10)

  return Csp::Map::BT709_Into::HDR10(Colour, Brightness);

#elif (ACTUAL_COLOUR_SPACE == CSP_BT2020_EXTENDED)

  return Csp::Map::BT709_Into::BT2020_Extended(Colour, Brightness);
...
void CS_Finalise()
{
  ...
  tex1Dstore(StorageConsolidated, COORDS_WAVEFORM_SCALE_WAS_DRAWN_TO, 0.f);

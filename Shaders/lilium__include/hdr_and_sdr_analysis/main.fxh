...
// waveform variables
#define LUMINANCE_WAVEFORM_VARIABLES_COUNT 5
...
#define COORDS_WAVEFORM_LAST_MODE             int(3 + LUMINANCE_WAVEFORM_VARIABLES_X_OFFSET)
#define COORDS_WAVEFORM_LAST_TEXT_SIZE_ADJUST int(4 + LUMINANCE_WAVEFORM_VARIABLES_X_OFFSET)
